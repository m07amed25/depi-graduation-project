...
function ThemeToggler({
  ...
  // Sync current state with external theme changes
  React.useEffect(() => {
  ...
  const toggleTheme = React.useCallback(
    async (newTheme: ThemeSelection) => {
      console.log("[ThemeToggler] Toggling to:", newTheme);
      ...
      if (newTheme === "system" && resolved === resolvedTheme) {
        console.log("[ThemeToggler] System theme already matches resolved.");
        setTheme(newTheme);
        return;
      }
      ...
      if (!doc.startViewTransition) {
        console.log(
          "[ThemeToggler] View Transition API not supported, falling back.",
        );
        flushSync(() => {
